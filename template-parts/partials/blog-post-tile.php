...
<article id="post-<?php the_ID(); ?>" <?php post_class('flex flex-col w-full h-full bg-white rounded-xl shadow overflow-hidden'); ?>>
    ...
    <div class="p-5 justify-between flex flex-col flex-1">
        ...
        <a href="<?php echo get_permalink() ?>" class="inline-flex w-fit items-center px-3 py-2 text-md text-center text-white bg-black rounded-lg hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-900">
