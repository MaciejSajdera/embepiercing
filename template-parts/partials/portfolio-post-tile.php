...
<div class="reveal-node reveal h-96 w-full mx-auto max-w-sm bg-white rounded-lg shadow overflow-hidden">
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('h-full'); ?>>
        ...
        <div class="rounded-t-lg w-full h-full bg-cover bg-top flex items-center content-center justify-center" style="background-image: url(<?php echo get_the_post_thumbnail_url() ?>)" alt="<?php the_title(); ?>" loading="lazy">
