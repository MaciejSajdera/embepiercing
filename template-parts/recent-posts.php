...
<?php if ( $the_query->have_posts() ) : ?>
   <section class="mb-48 md:mb-64">
      <h3 class="text-4xl md:text-6xl  mb-24 text-center uppercase">Najnowsze posty</h3>
                  ...
                  <div class="p-5 justify-between flex flex-col flex-1">
                     <div class="text-content">
                        ...
                        if (strlen(get_the_excerpt($post)) > 0) {
                           ...
                           echo '<p class="text-black text-base mt-4">'.mb_strimwidth( get_the_excerpt($post), 0, 220, '...' ).'</p>';
                        }
                        ?>
                     </div>
                     <a href="<?php echo get_post_permalink($post) ?>" class="mt-8 inline-flex w-fit items-center px-3 py-2 text-md text-center text-white bg-black rounded-lg hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-900">
