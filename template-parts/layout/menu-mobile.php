<div class="mobile-menu xl:hidden">
    ...
    <button id="mobileMenuToggle" class="menu-toggle nav-icon top-[0.5rem] right-2 z-50" aria-label="primary-menu-mobile" aria-controls="primary-menu-mobile" aria-expanded="false">
